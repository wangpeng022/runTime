new Vue({
    ...
    methods: {
        getTime() {
            ...
            this.min = Math.floor((this.date - this.m * (3600 * 24 * 30 * 1000) - (3600 * 24  * 1000) - this.d * (3600 * 24 * 1000) - this.h * (3600 * 1000)) / (60 * 1000));
            this.s = Math.floor((this.date - this.m * (3600 * 24 * 30 * 1000) - (3600 * 24  * 1000) - this.d * (3600 * 24 * 1000) - this.h * (3600 * 1000) - this.min * (60 * 1000)) / 1000);
        },
    },
    filters: {
        addZero(num) {
